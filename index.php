...
<div id="mapid" style="width: 750px; height: 500px"></div>
	...
	function mapa(lt,lg){
		if((lt==0) && (lg==0)){
			...
			//var mymap = L.map('mapid').setView([lt,lg], 17);
			alert("var mymap = L.map('mapid').setView(["+lt+", "+lg+"], 17);");
		}
...
<p>
<table>
<tr><td>Parque Socioambiental Dorothy Stang</td><td><button onclick="mapa(-22.896439, -47.169500);">Visitar</button></td></tr>
<tr><td>Parque Santa Clara (CREAPE)</td><td><button onclick="mapa(-22.890485, -47.199333);">Visitar</button></td></tr>
<tr><td>Parque Linear Chico Mendes</td><td><button onclick="mapa(-22.868042, -47.218688);">Visitar</button></td></tr>
<tr><td>Antiga Estação Ferroviária de Hortolândia</td><td><button onclick="mapa(-22.860132, -47.219354);">Visitar</button></td></tr>
</table>
<p>
